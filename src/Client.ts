    ...
    private handleIncoming(header: number, data: Uint8Array): void {
        ...
        switch (header) {
            case ServerBound.Input: {
                ...
                if ((flags & InputFlags.rightclick) && !(previousFlags & InputFlags.rightclick) && (player.currentTank === DevTank.Developer || player.currentTank === DevTank.Spectator || player.currentTank === DevTank.BigBoi)) {
