   ...
   public onDeath(killer: LivingEntity) {
    ...
    public tick(tick: number) {
        ...
        if (this.definition.flags.zoomAbility && (this.inputs.flags & InputFlags.rightclick)) {
            ...
            if (zoomScale + 100 <= 5000 && isRightClicked === false) {
                zoomScale += 500;
            ...
            if (!(this.cameraEntity.cameraData.values.flags & CameraFlags.usesCameraCoords)) {
                ...
                this.cameraEntity.cameraData.cameraX = Math.cos(angle) * zoomScale + this.positionData.values.x;
                this.cameraEntity.cameraData.cameraY = Math.sin(angle) * zoomScale + this.positionData.values.y;
            ...
            this.cameraEntity.cameraData.flags ^= CameraFlags.usesCameraCoords;
        } else if (this.definition.flags.zoomAbility && (this.inputs.flags & InputFlags.leftclick)) {

            if (zoomScale - 100 >= 1000 && isLeftClicked === false) {
                zoomScale -= 500;
        ...
        } else if (this.definition.flags.zoomAbility && !(this.inputs.flags & InputFlags.leftclick) && isLeftClicked === true) {

            isLeftClicked = false;
            
        } else if (this.definition.flags.zoomAbility && !(this.inputs.flags & InputFlags.rightclick) && isRightClicked === true) {
