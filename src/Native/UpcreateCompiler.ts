...
export const compileCreation = (camera: CameraEntity, w: Writer, entity: Entity) => {
 ...
 /* <template> auto-generated */ 
    ...
    if (hasStyle) w.float((camera.cameraData.player instanceof ObjectEntity && !(entity instanceof Trap) && entity.styleData?.opacity < 1) ? constrain((1000000 - entity.getWorldPosition().distanceToSQ(camera.cameraData.player.getWorldPosition())), 0, 1) / 1000000 : entity.styleData.values.opacity);
...
export const compileUpdate = (camera: Camera, w: Writer, entity: Entity) => {
 ...
 /* <template> auto-generated */ 
    ...
    if (hasStyle) if (entity.styleData.state[3]) {w.u8((52 - at) ^ 1); at = 52; w.float((camera.cameraData.player instanceof ObjectEntity && entity instanceof Trap && entity.styleData?.opacity < 1) ? constrain((1000000 - entity.getWorldPosition().distanceToSQ(camera.cameraData.player.getWorldPosition())), 0, 1) / 1000000 : entity.styleData.values.opacity);};
