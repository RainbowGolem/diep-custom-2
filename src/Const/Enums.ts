...
export const enum Color {
    ...
    Fallen = 17,
    EnemyHexagon = 18,
    EnemyPentagonTier2 = 19,
    EnemyPentagonTier3 = 20,
    EnemyPentagonTier4 = 21,
    EnemyPentagonTier5 = 22,
...
export const ColorsHexCode: Record<Color, number> = {
    ...
    [Color.EnemyHexagon]: 0xFF9E00,
    [Color.EnemyPentagonTier2]: 0x00FF9E, // светло зеленый
    [Color.EnemyPentagonTier3]: 0x0004FF, // черно синий
    [Color.EnemyPentagonTier4]: 0xFF00D8, // фиолетовый
    [Color.EnemyPentagonTier5]: 0xFF0000, // красный
