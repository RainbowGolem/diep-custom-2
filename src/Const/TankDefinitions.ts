...
export interface BarrelDefinition {
    /** The ammount of barrels that the tank has...  */
    barrelsAmmount: number;
    ...
    reload: number;
    /** The time before the tank will start reloading... default 30*/
    shotsBeforeReload: number;
    /** The time that the tank reloads... default 300*/
